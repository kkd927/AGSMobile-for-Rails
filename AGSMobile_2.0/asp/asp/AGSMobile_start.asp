...
<%
	...
	'
	Dim amt,dutyfree,strAegis,strCsrf	
...
<form method="post" action="<%=strAegis%>/payment/mobilev2/intro.jsp" name="form">
	<table>
		...
		<tr>
			<td>상점아이디</td>
			<td><input type=text name=StoreId maxlength=20 value="aegis"/></td>
		</tr>
		<tr>
			<td>상점URL</td>
			<td><input type=text  name=MallUrl value="http://<%=Request.ServerVariables("server_name")%>"/></td>
		</tr>
		<tr>
			<td>회원아이디</td>
		...
		<tr>
			<td>성공 URL</td>
			<td><input type=text  name=RtnUrl value="http://<%=Request.ServerVariables("server_name")%>/samples/asp/AGSMobile_approve.asp"></td>
		</tr>
		<tr>
		...
		<tr>
			<td>취소 URL</td>
			<td><input type=text  name=CancelUrl value="http://<%=Request.ServerVariables("server_name")%>/samples/asp/AGSMobile_user_cancel.asp"></td>
		</tr>
		<tr>
			<td>추가사용필드1</td>
		...
		<tr>
			<td>통보페이지</td>
			<td><input type=text name=MallPage maxlength=100 value="/samples/asp/AGSMobile_virtual_result.asp"></td>
		</tr>
		<tr>
			<td>입금예정일</td>
